...
template <typename RIT, typename CIT, typename VT= long double, typename CPT=size_t>
CSC<RIT, VT, CPT> SpAddRegular(CSC<RIT, VT, CPT>* A, CSC<RIT, VT, CPT>* B){
    auto nnzCPerCol = symbolicSpAddRegularDynamic<RIT,CIT,VT,CPT>(A, B);
    return SpAddRegularDynamic<RIT,CIT,VT,CPT>(A, B, nnzCPerCol);
}
